...
-- █   █ ▄▀▄ █▀▄ █▄▀ ▄▀▀ █▀▄ ▄▀▄ ▄▀▀ ██▀   █▄ ▄█ ▄▀▄ █▀▄ ██▀ ▄▀▀
-- ▀▄▀▄▀ ▀▄▀ █▀▄ █ █ ▄██ █▀  █▀█ ▀▄▄ █▄▄   █ ▀ █ ▀▄▀ █▄▀ █▄▄ ▄██
hl.bind(mainMod .. " SHIFT + Space", hl.dsp.workspace.opt("allfloat"))
hl.bind(mainMod .. " SHIFT + P", hl.dsp.workspace.opt("allpseudo"))
...
--  Monitor Move   --
---------------------
hl.bind(mainMod .. " CTRL + M + 1", hl.dsp.exec_cmd(custom_scripts .. "/move_workspace.sh 1"))
hl.bind(mainMod .. " CTRL + M + 2", hl.dsp.exec_cmd(custom_scripts .. "/move_workspace.sh 2"))
